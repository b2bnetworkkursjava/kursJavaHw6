...
public class ClothesShopUtils {
    ...
    public boolean checkCityAndStreet(ClothesShop clothesShop) {
        if (clothesShop.getStreet().equals("Grochowska") && clothesShop.getCity().equals("Warszawa")) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean checkBrandAndSize(ClothesShop clothesShop) {
        if (clothesShop.getCloth().getBrand().equals("Puma") && clothesShop.getCloth().getSize().equals("S")) {
            return true;
        } else {
            return false;
        }
